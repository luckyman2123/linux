/* linux/arch/arm/mach-s5pv210/mach-fs210.c
 *
 * Copyright (c) 2012 farsight Tech
 *		http://dev.hqyj.com
 *
...
#define FS210_UCON_DEFAULT	(S3C2410_UCON_TXILEVEL |	\
...
#define FS210_ULCON_DEFAULT	S3C2410_LCON_CS8

#define FS210_UFCON_DEFAULT	(S3C2410_UFCON_FIFOMODE |	\
				 S5PV210_UFCON_TXTRIG4 |	\
				 S5PV210_UFCON_RXTRIG4)

static struct s3c2410_uartcfg fs210_uartcfgs[] __initdata = {
	[0] = {
		.hwport		= 0,
		.flags		= 0,
		.ucon		= FS210_UCON_DEFAULT,
		.ulcon		= FS210_ULCON_DEFAULT,
		.ufcon		= FS210_UFCON_DEFAULT,
	},
	[1] = {
		.hwport		= 1,
		.flags		= 0,
...
/* LDO */
static struct regulator_consumer_supply fs210_ldo3_consumer[] = {
	REGULATOR_SUPPLY("pd_io", "s3c-usbgadget"),
	REGULATOR_SUPPLY("pd_io", "s5p-ohci"),
	REGULATOR_SUPPLY("pd_io", "s5p-ehci"),
};

static struct regulator_consumer_supply fs210_ldo5_consumer[] = {
	REGULATOR_SUPPLY("AVDD", "0-001b"),
	REGULATOR_SUPPLY("DVDD", "0-001b"),
};

static struct regulator_consumer_supply fs210_ldo8_consumer[] = {
	REGULATOR_SUPPLY("pd_core", "s3c-usbgadget"),
	REGULATOR_SUPPLY("pd_core", "s5p-ohci"),
	REGULATOR_SUPPLY("pd_core", "s5p-ehci"),
};

static struct regulator_init_data fs210_ldo2_data = {
	.constraints	= {
		.name		= "VALIVE_1.1V",
		.min_uV		= 1100000,
		.max_uV		= 1100000,
...
static struct regulator_init_data fs210_ldo3_data = {
	.constraints	= {
	...
	.num_consumer_supplies	= ARRAY_SIZE(fs210_ldo3_consumer),
	.consumer_supplies	= fs210_ldo3_consumer,
};

static struct regulator_init_data fs210_ldo4_data = {
	.constraints	= {
		.name		= "V_MIPI_1.8V",
		.min_uV		= 1800000,
		.max_uV		= 1800000,
...
static struct regulator_init_data fs210_ldo5_data = {
	.constraints	= {
		.name		= "VMMC+VEXT_2.8V",
		.min_uV		= 2800000,
		.max_uV		= 2800000,
	...
	.num_consumer_supplies	= ARRAY_SIZE(fs210_ldo5_consumer),
	.consumer_supplies	= fs210_ldo5_consumer,
};

static struct regulator_init_data fs210_ldo6_data = {
	.constraints	= {
		.name		= "VCC_2.6V",
		.min_uV		= 2600000,
		.max_uV		= 2600000,
...
static struct regulator_init_data fs210_ldo7_data = {
	.constraints	= {
		.name		= "VDAC_2.8V",
		.min_uV		= 2800000,
		.max_uV		= 2800000,
...
static struct regulator_init_data fs210_ldo8_data = {
	.constraints	= {
	...
	.num_consumer_supplies	= ARRAY_SIZE(fs210_ldo8_consumer),
	.consumer_supplies	= fs210_ldo8_consumer,
};

static struct regulator_init_data fs210_ldo9_data = {
	.constraints	= {
...
/* BUCK */
static struct regulator_consumer_supply fs210_buck1_consumer =
	REGULATOR_SUPPLY("vddarm", NULL);

static struct regulator_consumer_supply fs210_buck2_consumer =
	REGULATOR_SUPPLY("vddint", NULL);

static struct regulator_init_data fs210_buck1_data = {
	.constraints	= {
		.name		= "VCC_ARM",
		.min_uV		= 750000,
		.max_uV		= 1500000,
	...
	.consumer_supplies	= &fs210_buck1_consumer,
};

static struct regulator_init_data fs210_buck2_data = {
	.constraints	= {
		.name		= "VCC_INTERNAL",
		.min_uV		= 950000,
		.max_uV		= 1200000,
	...
	.num_consumer_supplies	= 1,
	.consumer_supplies	= &fs210_buck2_consumer,
};

static struct regulator_init_data fs210_buck3_data = {
	.constraints	= {
		.name		= "VCC_MEM",
		.min_uV		= 1800000,
		.max_uV		= 1800000,
...
static struct max8698_regulator_data fs210_regulators[] = {
	{ MAX8698_LDO2,  &fs210_ldo2_data },
	{ MAX8698_LDO3,  &fs210_ldo3_data },
	{ MAX8698_LDO4,  &fs210_ldo4_data },
	{ MAX8698_LDO5,  &fs210_ldo5_data },
	{ MAX8698_LDO6,  &fs210_ldo6_data },
	{ MAX8698_LDO7,  &fs210_ldo7_data },
	{ MAX8698_LDO8,  &fs210_ldo8_data },
	{ MAX8698_LDO9,  &fs210_ldo9_data },
	{ MAX8698_BUCK1, &fs210_buck1_data },
	{ MAX8698_BUCK2, &fs210_buck2_data },
	{ MAX8698_BUCK3, &fs210_buck3_data },
};

static struct max8698_platform_data fs210_max8698_pdata = {
	.num_regulators = ARRAY_SIZE(fs210_regulators),
	.regulators     = fs210_regulators,
...
static struct s3c_ide_platdata fs210_ide_pdata __initdata = {
	.setup_gpio	= s5pv210_ide_setup_gpio,
};

static uint32_t fs210_keymap[] __initdata = {
	/* KEY(row, col, keycode) */
...
static struct matrix_keymap_data fs210_keymap_data __initdata = {
	.keymap		= fs210_keymap,
	.keymap_size	= ARRAY_SIZE(fs210_keymap),
};

static struct samsung_keypad_platdata fs210_keypad_data __initdata = {
	.keymap_data	= &fs210_keymap_data,
	.rows		= 8,
	.cols		= 8,
};

#ifdef CONFIG_DM9000
static struct resource fs210_dm9000_resources[] = {
	[0] = {
...
struct platform_device fs210_dm9000 = {
	.name		= "dm9000",
	.id		= -1,
	.num_resources	= ARRAY_SIZE(fs210_dm9000_resources),
	.resource	= fs210_dm9000_resources,
	.dev		= {
		.platform_data	= &fs210_dm9000_platdata,
	},
};
...
static struct regulator_consumer_supply fs210_b_pwr_5v_consumers[] = {
        {
                /* WM8580 */
                .supply         = "PVDD",
                .dev_name       = "0-001b",
...
static struct regulator_init_data fs210_b_pwr_5v_data = {
        .constraints = {
                .always_on = 1,
        },
        .num_consumer_supplies  = ARRAY_SIZE(fs210_b_pwr_5v_consumers),
        .consumer_supplies      = fs210_b_pwr_5v_consumers,
};

static struct fixed_voltage_config fs210_b_pwr_5v_pdata = {
        .supply_name    = "B_PWR_5V",
        .microvolts     = 5000000,
        .init_data      = &fs210_b_pwr_5v_data,
};

static struct platform_device fs210_b_pwr_5v = {
        .name          = "reg-fixed-voltage",
        .id            = -1,
        .dev = {
                .platform_data = &fs210_b_pwr_5v_pdata,
        },
};
#endif
#ifdef CONFIG_TOUCHSCREEN_EGALAX
...
#endif
struct platform_device fs210_gsensor = {
...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMC0	(6144 * SZ_2K)//(6144 * SZ_1K)
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMC1	(9900 * SZ_2K)//(9900 * SZ_1K)
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMC2	(6144 * SZ_2K)//(6144 * SZ_1K)
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC0		(36864 * SZ_1K)
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC1		(36864 * SZ_1K)
#if (CONFIG_VIDEO_SAMSUNG_MEMSIZE_FIMD == 0)
...
#else
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMD		(3072 * SZ_4K)
#endif
...
static void fs210_lcd_set_power(struct plat_lcd_data *pd,
					unsigned int power)
{
	if (power) {
...
static struct plat_lcd_data fs210_lcd_data = {
	.set_power	= fs210_lcd_set_power,
};

static struct platform_device fs210_lcd_platdata = {
	.name			= "platform-lcd",
	.dev.parent		= &s3c_device_fb.dev,
	.dev.platform_data	= &fs210_lcd_data,
};
...
#if defined(CONFIG_FB_S3C_VGA640480) || defined(CONFIG_FB_S3C_VGA800600)
...
static struct platform_pwm_backlight_data smdk_backlight_data = {
	...
	.max_brightness = 255,
	.dft_brightness = 255,
	.pwm_period_ns  = 20000,//25000,由于背光频率太高，这个IO端口长度不行
};
...
static struct gpio_keys_button fs210_hs0038[] = {
		{
...
static struct gpio_keys_platform_data fs210_hs0038_data = {
	.buttons	= fs210_hs0038,
	.nbuttons	= ARRAY_SIZE(fs210_hs0038),
};

struct platform_device fs210_hs0038_device = {
	.name		= "hs0038",
	.id		= -1,
	.dev		= {
		.platform_data	= &fs210_hs0038_data,
	}
};
#endif
/*********************************************************************************************************/
...
#elif 1
#define GPIO_SCK5		S5PV210_GPG2(5)
#define GPIO_SDA5		S5PV210_GPG2(6)
#endif 
...
static struct platform_device *fs210_devices[] __initdata = {
...
//------------------------------	
	...
	&s5pv210_device_ac97,
#endif
#ifdef CONFIG_SND_SOC_WM8960_FS210
	&s5pv210_device_iis1,
	&s5pv210_device_iis0,
#endif
...
#endif
	&fs210_lcd_platdata,
	&s3c_device_timer[0],//这个地方要修改
	&s3c_device_timer[1],
	&s3c_device_timer[2],
	&s3c_device_timer[3],
//	&fs210_backlight_device,
...
#ifdef CONFIG_DM9000
static void __init fs210_dm9000_init(void)
{
	unsigned int tmp;
...
static struct s3c2410_platform_i2c fs210_gt801_pdata __initdata = {
   .flags        = 0,
   .slave_addr    = 0xaa>>1,
   //.slave_addr    = 0x50,
...
#ifdef CONFIG_MTD_NAND
static struct mtd_partition fs210_partition_info[] = {
	[0] = {
		.name		= "Bootloader",
		.offset		= 0,
		.size		= 0x100000,
...
/*	[1] = {
	...
	/*[4] = {
		.name		= "ROOTFS",
		.offset		= 0x700000,//C800000MTDPART_SIZ_FULL
		.size		= 0xc800000,//内核文件系统不能挂满
	},*/
	/*[4] = {
		.name		= "RES",
		.offset		= 0x700000,//C800000MTDPART_SIZ_FULL
		.size		= 0x100000,//内核文件系统不能挂满		
	},*/
	
	[3] = {
		#if defined(CONFIG_K9F2G08_SIZE)
		.name		= "ROOTFS",
		.offset		= 0x700000,
		.size		= 0xF800000,//F200000 MTDPART_SIZ_FULL F000000(240m) 0xc800000 c9 EB00000(235m) E600000(230m)F500000(245m) 100000(1m)
...
struct s3c_nand_mtd_info fs210_nand_info = {
	.chip_nr = 1,
	.mtd_part_nr = ARRAY_SIZE(fs210_partition_info),
	.partition = fs210_partition_info
};
#endif

#if defined(CONFIG_MFD_TPS65910)
static struct tps65910_board fs210_tps65910_pdata = {
...
#endif
static struct i2c_board_info fs210_i2c_devs0[] __initdata = {
	{ I2C_BOARD_INFO("24c08", 0x50), },     /* Samsung S524AD0XD1 */
	{ I2C_BOARD_INFO("wm8580", 0x1b), },
#ifdef CONFIG_SND_SOC_WM8960_FS210//lhh add
	{
		I2C_BOARD_INFO("wm8960", 0x1a),
		.platform_data  = &wm8960_pdata,
	},
#endif
#if defined(CONFIG_MFD_TPS65910) //lhh add
	{ I2C_BOARD_INFO("tps65910", 0x2d>>1),
		.platform_data  = &fs210_tps65910_pdata,	
	 },
#endif

};

static struct i2c_board_info fs210_i2c_devs1[] __initdata = {
#ifdef CONFIG_VIDEO_TV20
	{
...
static struct i2c_board_info fs210_i2c_devs2[] __initdata = {
#if defined(CONFIG_REGULATOR_MAX8698)
	{
		I2C_BOARD_INFO("max8698", 0xCC >> 1),
		.platform_data  = &fs210_max8698_pdata,
	},
#endif
#if defined(CONFIG_TOUCHSCREEN_S3C_GX801)
	{ I2C_BOARD_INFO("gx801", 0xaa>>1),
	  .irq = IRQ_EINT(14),
	  .platform_data  = &fs210_gt801_pdata,	
	},
...
static void __init fs210_map_io(void)
{
	s5p_init_io(NULL, 0, S5P_VA_CHIPID);
	s3c24xx_init_clocks(24000000);
	s5pv210_gpiolib_init();
	s3c24xx_init_uarts(fs210_uartcfgs, ARRAY_SIZE(fs210_uartcfgs));
#ifndef CONFIG_S5P_HIGH_RES_TIMERS
	s5p_set_timer_source(S5P_PWM2, S5P_PWM4);
#endif
	s5p_reserve_bootmem(s5pv210_media_devs, ARRAY_SIZE(s5pv210_media_devs), S5P_RANGE_MFC);
#ifdef CONFIG_MTD_ONENAND
...
static struct s3c_sdhci_platdata fs210_hsmmc3_pdata __initdata = {
...
/* USB EHCI */
static struct s5p_ehci_platdata fs210_ehci_pdata;
static void __init fs210_ehci_init(void)
{
	struct s5p_ehci_platdata *pdata = &fs210_ehci_pdata;

	s5p_ehci_set_platdata(pdata);
}

/*USB OHCI*/
static struct s5p_ohci_platdata fs210_ohci_pdata;
static void __init fs210_ohci_init(void)
{
	struct s5p_ohci_platdata *pdata = &fs210_ohci_pdata;

	s5p_ohci_set_platdata(pdata);
}

/*USB DEVICE*/
static struct s5p_otg_platdata fs210_otg_pdata;
static void __init fs210_otg_init(void)
{
	struct s5p_otg_platdata *pdata = &fs210_otg_pdata;

	s5p_otg_set_platdata(pdata);
}

static void __init fs210_machine_init(void)
{
#if defined(CONFIG_TOUCHSCREEN_S3C)
...
#endif
#ifdef CONFIG_MTD_NAND
	s3c_device_nand.dev.platform_data = &fs210_nand_info;
#endif
	s3c_pm_init();
	...
	fs210_dm9000_init();
#endif
	platform_add_devices(fs210_devices, ARRAY_SIZE(fs210_devices));
	...
	samsung_keypad_set_platdata(&fs210_keypad_data);
	...
	i2c_register_board_info(0, fs210_i2c_devs0, ARRAY_SIZE(fs210_i2c_devs0));
	i2c_register_board_info(1, fs210_i2c_devs1, ARRAY_SIZE(fs210_i2c_devs1));
	i2c_register_board_info(2, fs210_i2c_devs2, ARRAY_SIZE(fs210_i2c_devs2));
#ifdef CONFIG_TOUCHSCREEN_EGALAX
	i2c_register_board_info(5, i2c_devs5, ARRAY_SIZE(i2c_devs5));
#endif

	s3c_ide_set_platdata(&fs210_ide_pdata);

//	s3c_fb_set_platdata(&fs210_lcd0_pdata);
	s3c_fb_set_platdata(&EmbedSky_LCD_fb_data);

#ifdef CONFIG_S3C_DEV_HSMMC
	s3c_sdhci0_set_platdata(&smdkc110_hsmmc0_pdata);
	s3c_sdhci3_set_platdata(&fs210_hsmmc3_pdata);
#endif
...
MACHINE_START(FS210, "FS210")
	/* Maintainer: Kukjin Kim <kgene.kim@samsung.com> */
	.boot_params	= S5P_PA_SDRAM + 0x100,
	.init_irq	= s5pv210_init_irq,
	.map_io		= fs210_map_io,
	.init_machine	= fs210_machine_init,
