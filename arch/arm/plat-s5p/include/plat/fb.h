...
struct s3c_platform_fb {
	...
	void            *lcd;
	void		(*cfg_gpio)(struct platform_device *dev);//功能管脚设置
	int		(*backlight_on)(struct platform_device *dev);//背光设置
...
struct s3c_fb_platdata {
	void	(*setup_gpio)(void); //功能引脚设置

	struct s3c_fb_pd_win	*win[S3C_FB_MAX_WIN];//窗口设置 A8有多窗口
