...
// Begin: Added by lishihong for BugID 19741 on 2018-08-30
#include <linux/prj_macro_ctrl.h>
#include <linux/wakelock.h>
#include <odm-msg/msg.h>
// End: Added by lishihong for BugID 19741 on 2018-08-30
...
// Begin: Added by lishihong for BugID 19741 on 2018-08-30
#ifdef PROJECT_OPEN_CPU
static void notify_work_thread(struct work_struct *work)
{
    struct qpnp_rtc *rtc_dd =
        container_of(work, struct qpnp_rtc, work_thread);

    __pm_stay_awake(&rtc_dd->ws);
    odm_msg_type msg;
    msg.id  = ODM_MSG_ID_RTC_ALARM;
    msg.val = 1;
    odm_notify(&msg, sizeof(msg));
    printk("T ------> notify.\n");
    __pm_relax(&rtc_dd->ws);
}
#endif
// End: Added by lishihong for BugID 19741 on 2018-08-30
...
// Begin: Added by lishihong for BugID 19741 on 2018-08-30
#ifdef PROJECT_OPEN_CPU
    schedule_work(&rtc_dd->work_thread);
#endif
// End: Added by lishihong for BugID 19741 on 2018-08-30
...
// Begin: Added by lishihong for BugID 19741 on 2018-08-30
#ifdef PROJECT_OPEN_CPU
    wakeup_source_init(&rtc_dd->ws, "rtc-alarm");
    INIT_WORK(&rtc_dd->work_thread, notify_work_thread);
#endif
// End: Added by lishihong for BugID 19741 on 2018-08-30
