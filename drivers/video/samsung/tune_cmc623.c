...
static unsigned short cmc6230_probe[] = { 8, (0x38), I2C_CLIENT_END }; // 何泼  救凳 P1_LSJ : DE07
*/
//static unsigned short cmc6230_probe[] = { 8, (0x70), I2C_CLIENT_END }; // 何泼 OK 
//static unsigned short cmc6230_probe[] = { 8, (0x70 >> 1), I2C_CLIENT_END };    // Error 惯积 
#else 
...
static int cmc623_load_data(void)
{
	...
	ret = vfs_read(filp, (char __user *)dp, l, &pos);   // P1_LSJ : DE08 : 咯扁辑 磷澜 
...
int cmc623_test(void)
{
    ...
    // a27  // P1_LSJ DE13
    // add, value // DNR:bypass, HDTR: bypass Gamma:历炼档 down 2 歹 撤霸
