...
//#define CONFIG_FS210_DEBUG_BEEP
...
static int fs210_beep_open(struct inode *inode, struct file *file)
{
	unsigned long pclk;//
	struct clk *clk_p;
	...
	fs210_beep_debug(BEEP_ON, 20);
	mdelay(1000);
	printk(" beep value is : 40.....\n\n");
	fs210_beep_debug(BEEP_ON, 40);
	mdelay(1000);
	printk(" beep value is : 80.....\n\n");
	fs210_beep_debug(BEEP_ON, 80);
	mdelay(1000);
	printk(" beep value is : 100.....\n\n");
	fs210_beep_debug(BEEP_ON, 100);
	mdelay(2000);
	printk(" beep off.....\n\n");
	fs210_beep_debug(BEEP_OFF, 100);//off
...
{
        .owner=THIS_MODULE,
        .unlocked_ioctl=fs210_beep_ioctl,
	.open = fs210_beep_open,
	.release 	= fs210_adc_close,
};
static struct miscdevice fs210_beep_miscdev = {
...
//#ifdef CONFIG_S3C64XX_PWM
	...
	*clk |= (1<<23);
	//printk(" last:%x\n ",*clk);
	ret = misc_register(&fs210_beep_miscdev);
	...
	printk(KERN_INFO "FS210 Beep driver successfully probed\n");
