...
static void  msm_serial_hs_rt_init(struct uart_port *uport)
{
	...
	pm_runtime_set_suspended(uport->dev);
//<!---[BUGID]27484 high speed uart use low baudrate will suspend uart device lihongbin@20190929 start
//	pm_runtime_set_autosuspend_delay(uport->dev, 100);
	pm_runtime_set_autosuspend_delay(uport->dev, -1);
//<!---[BUGID]27484 high speed uart use low baudrate will suspend uart device lihongbin@20190929 end
