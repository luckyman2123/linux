...
static const struct reg_default init_list[] = {
	...
	{RT5616_LOUT_MIXER, 0xc000},
	{RT5616_LOUT_CTRL1, 0x8888},
	{RT5616_LOUT_CTRL2, 0x8000},
	{RT5616_DAC1_DIG_VOL, 0x9f9f},
	/* HPO */
	{RT5616_HP_VOL, 0x8888},
	{RT5616_HPO_MIXER, 0x5000},
	{RT5616_AD_DA_MIXER, 0x8080},
	/* Mic */
	{RT5616_GLB_CLK, 0x5000},
	{RT5616_IN1_IN2, 0x2000},
	{RT5616_STO1_ADC_MIXER, 0x3820},
	{RT5616_REC_L2_MIXER, 0x006d},
	{RT5616_REC_R2_MIXER, 0x006d},
	/* DAC over sample-rate 128FS */
	{RT5616_ADDA_CLK1, 0x1000}, // Added by lishiong for BugID 14710 on 2018-01-25
};
			    ...
			    struct snd_soc_dai *dai)
{
	...
	dev_err(codec->dev, "rt5616->lrck[dai->id]=%d,rt5616->sysclk=%d\n",rt5616->lrck[dai->id],rt5616->sysclk);
	if (pre_div < 0) {
			    ...
			    const struct i2c_device_id *id)
{
	...
	for (i = 0; i < ARRAY_SIZE(init_list); i++) {
		regmap_write(rt5616->regmap, init_list[i].reg, init_list[i].def);
	}
#endif
	regmap_update_bits(rt5616->regmap, RT5616_PWR_ANLG1,
